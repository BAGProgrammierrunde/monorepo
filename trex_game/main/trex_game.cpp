...
uint16_t rainbow16(uint32_t step) {
  ...
  switch (x >> 8) {             // Segment 0..5
    case 0: r = 255;     g = t;       b = 0;       break; // Rot -> Gelb
    case 1: r = 255 - t; g = 255;     b = 0;       break; // Gelb -> Grün
    case 2: r = 0;       g = 255;     b = t;       break; // Grün -> Cyan
    case 3: r = 0;       g = 255 - t; b = 255;     break; // Cyan -> Blau
    case 4: r = t;       g = 0;       b = 255;     break; // Blau -> Magenta
    default: // case 5
      r = 255;     g = 0;       b = 255 - t; break; // Magenta -> Rot
  }
  return rgb565(r, g, b);
}
