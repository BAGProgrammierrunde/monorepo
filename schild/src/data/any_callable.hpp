...
namespace me {
    ...
    class any_callable {}; // Not defined
    ...
    private:
        ...
        Callable<T>* getCallableRef() {
            return anyCallable.template getDerived<Callable<T>>(); // with .template getDerived... // Dependent template shit??
        }
