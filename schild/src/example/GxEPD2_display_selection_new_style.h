...
#else
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ 39, /*DC=*/ 5, /*RST=*/ 6, /*BUSY=*/ 4)); // my suggested wiring and proto board
